        ...
        <section className="mx-auto grid max-w-6xl gap-10 px-6 py-16 md:grid-cols-2 md:items-center">
          <div>
            ...
            <p className="mt-5 max-w-xl text-lg leading-8 text-zinc-600">
              Fast, clean, reliable service without the shop wait. OB Mobile Garage brings oil changes and basic maintenance right to your driveway.
            </p>
          ...
          <div className="mx-auto max-w-6xl px-6 py-14">
            ...
            <div className="mt-8 grid gap-4 md:grid-cols-3">
              <div className="rounded-2xl border border-zinc-200 bg-white p-5 shadow-sm">
                ...
                <p className="mt-2 text-sm leading-6 text-zinc-600">Fill out the quick service request form with your vehicle details and preferred time.</p>
              </div>
              <div className="rounded-2xl border border-zinc-200 bg-white p-5 shadow-sm">
                <p className="text-sm font-semibold text-orange-600">2. We confirm</p>
                <p className="mt-2 text-sm leading-6 text-zinc-600">We contact you to lock in your appointment and service details.</p>
              </div>
              <div className="rounded-2xl border border-zinc-200 bg-white p-5 shadow-sm">
                <p className="text-sm font-semibold text-zinc-900">3. We come to you</p>
                <p className="mt-2 text-sm leading-6 text-zinc-600">Service at your home or job site with no waiting room and no wasted time.</p>
              </div>
            </div>
          </div>
        </section>
          ...
          <div className="grid gap-8 lg:grid-cols-[0.9fr_1.1fr] lg:items-start">
            <div>
              ...
              <p className="mt-4 text-zinc-600 leading-7">
                Use the form below to request service without leaving the website. Once we receive it, we’ll reach out to confirm your appointment.
              </p>
        ...
        <section className="bg-white">
          <div className="mx-auto max-w-6xl px-6 py-16">
            <div className="mx-auto max-w-3xl text-center">
              ...
              <h3 className="mt-4 text-3xl font-bold tracking-tight">Built on convenience, cleanliness, and reliability</h3>
              <p className="mt-4 text-zinc-600 leading-7">
            ...
            <div className="mt-10 grid gap-6 md:grid-cols-3">
              ...
              <div className="rounded-3xl border border-zinc-200 bg-zinc-50 p-6 shadow-sm">
                ...
                <p className="mt-4 text-sm font-semibold text-zinc-900">Colorado Springs area customer</p>
              </div>
            </div>
          </div>
        </section>
        ...
        <div className="mx-auto max-w-6xl px-6 py-8 flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-zinc-600">Mobile oil change service for 80831 & surrounding areas.</p>
            </div>
          </div>
