      ...
      <section className="reviews">
        ...
        <div className="review-grid">
          <div className="review-card">
            ...
            <p>Super convenient and easy. Having the oil change done at home saved me a ton of time.</p>
            <strong>Local customer</strong>
          </div>
          <div className="review-card">
            <div className="stars">★★★★★</div>
            <p>Clean, professional, and straightforward pricing. Exactly what I was looking for.</p>
            <strong>Mobile service client</strong>
          </div>
          <div className="review-card">
            <div className="stars">★★★★★</div>
            <p>Great option for busy schedules. The service at my job site made it easy.</p>
